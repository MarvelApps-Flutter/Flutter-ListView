...
import 'package:listview_module/model/order_model.dart';
...
class OrderDetailScreen extends StatelessWidget {
  ...
  Divider _seprator() => Divider(height: 1,thickness: 0.7,color: Colors.grey.shade300,);
  ...
  Container _invoiceContainer() {
    return Container(
            ...
            child: Row(
              children: [
                Icon(Icons.book_rounded,color: Colors.blue.shade900,),
                const Padding(
  ...
  Container _priceDetailContainer() {
    return Container(
            ...
            child: Column(
              children: [
                _priceDetail('Selling Price','Rs.'+orderItem.sellingPrice.toString()),
                _priceDetail('shipping fee', 'Rs.'+orderItem.shippingFee.toString()),
                _priceDetail('Shipping discount', '-Rs.'+orderItem.shippingDiscount.toString(),),
                _priceDetail('Total Amount', 'Rs.'+orderItem.amount,fontWeight: FontWeight.bold)
              ],
            ),
          );
  }
              ...
              children: [
                Row(
                  children: List.generate(5, (index1){
                    return CommonComponent.getRating(context, index, index1,size: 30);
                  }),
                ),
                  ...
                  style:const TextStyle(
                    ...
                    Container(
                      ...
                      decoration:BoxDecoration(
                        image: DecorationImage(image: NetworkImage(orderItem.imageUrl),fit: BoxFit.fill),
                      )
                    )
                  ],
                ),
  ...
  Widget _priceDetail(String title, String amount,{FontWeight fontWeight=FontWeight.w400}) {
    return Padding(
